...
class TestDaySummaryApi:
    @pytest.mark.parametrize(
        "coin, date, expected",
        [
            ("BTC", datetime.date(2022, 2, 1), "https://www.mercadobitcoin.net/api/BTC/day-summary/2022/2/1"),
            ("ETH", datetime.date(2022, 2, 1), "https://www.mercadobitcoin.net/api/ETH/day-summary/2022/2/1"),
            ("ETH", datetime.date(2021, 6, 12), "https://www.mercadobitcoin.net/api/ETH/day-summary/2021/6/12")            
        ]
    )
