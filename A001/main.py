...
A combinação de Pares, impares e Primos mais frequentes é: {} com a frequencia de: {}%
'''.format(freq_nr[-1][0], freq_nr[0][0], freq_nr[-1][0], resultado['Combinacao'].values[-1], int((resultado['p_freq'].values[-1]*100)*100)/100 )
)